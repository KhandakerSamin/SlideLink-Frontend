      ...
      <div className="max-w-7xl pb-20  mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/create"
              className="group relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-violet-600 text-white px-8 py-4 rounded-xl font-medium transition-all duration-300 flex items-center space-x-2 text-lg hover:shadow-lg hover:shadow-blue-500/25"
            >
